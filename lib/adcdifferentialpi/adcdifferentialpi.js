//
// ================================================
// ABElectronics ADC Differential Pi 8 Channel Analogue to Digital Converter
// For use with the ADC Differential Pi and Delta Sigma Pi
...
let config1 = 0x9C;  // PGAx1, 18 bit, continuous conversion, channel 1
let currentChannel1 = 0;  // channel variable for ADC 1
let config2 = 0x9C;  // PGAx1, 18 bit, continuous-shot conversion, channel 1
let currentChannel2 = 0;  // channel variable for ADC 2
let pga = 0.5;  // current PGA setting
let lsb = 0.0000078125;  // default LSB value for 18 bit
let signBit = false; // stores whether the value contains a sign bit showing it is positive or negative.

const ADCDifferentialPi = (function () {

    ADCDifferentialPi.prototype.address1 = 0x68;
    ADCDifferentialPi.prototype.address2 = 0x69;
    ADCDifferentialPi.prototype.pga = 1;
    ADCDifferentialPi.prototype.bitRate = 18;
    ADCDifferentialPi.prototype.conversionMode = 1;
    ...
    ADCDifferentialPi.prototype.readVoltage = function (channel) {
        /// <summary>
        ...
        if (signBit) // check to see if the sign bit is present, if it is then the voltage is negative and can be ignored.
        {
            ...
            voltage = raw * (lsb / pga); // calculate the voltage and return it

        }
        return voltage;
    }

    ADCDifferentialPi.prototype.readRaw = function (channel) {
        /// <summary>
    ...
    ADCDifferentialPi.prototype.setPGA = function (gain) {
        /// <summary>
    ...
    ADCDifferentialPi.prototype.setBitRate = function (rate) {
        /// <summary>
    ...
    ADCDifferentialPi.prototype.setConversionMode = function (mode) {
        /// <summary>
...
module.exports = ADCDifferentialPi;
